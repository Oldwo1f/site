...
app.controller('edittopicsCtrl',['$scope','$stateParams','filterFilter','configService','topicsService','$state','$filter','topic','messageCenterService',
function edittopicsCtrl($scope,$stateParams,filterFilter,configService ,topicsService ,$state,$filter,topic,messageCenterService) {
    $('.editModal').modal();
   ...
   console.log($scope.editTopic);
    $scope.submitEdit = function() {
        ...
        topicsService.edit($scope.editTopic).then(function() {
